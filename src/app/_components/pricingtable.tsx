...
import {
  ...
  const comparisons = [
    {
      compItem: "Custom Site Design",
      plan1: true,
      plan2: true,
      plan3: true,
    },
    {
      compItem: "Interactive Animations",
      plan1: true,
      plan2: true,
      plan3: false,
    },
    {
      compItem: "Custom Modules",
      plan1: true,
      plan2: false,
      plan3: false,
    },
    ...
    return (
        <Table className="my-8">
            ...
            {/* Each header column represents an available pricing plan */}
                <TableRow>
                    <TableHead></TableHead>
                    <TableHead className="text-center">Plan 1</TableHead>
                    <TableHead className="text-center">Plan 2</TableHead>
                    <TableHead className="text-center">Plan 3</TableHead>
                </TableRow>
            </TableHeader>
            <TableBody>
            ...
            {comparisons.map((invoice) => (
                <TableRow key={invoice.compItem}>
                    <TableCell>{invoice.compItem}</TableCell>
                    <TableCell>{invoice.plan1 ? checkBadge : <></>}</TableCell>
                    <TableCell>{invoice.plan2 ? checkBadge : <></>}</TableCell>
            ...
            <TableFooter>
                <TableRow>
                    ...
                    <TableCell>
                        <Button className="btn btn-primary md:ml-12">Contact Us</Button>
                    </TableCell>
                    <TableCell>
                        <Button className="btn btn-primary md:ml-12">Contact Us</Button>
                    </TableCell>
