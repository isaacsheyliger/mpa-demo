...
export function Footer() {
  return (
    <footer className="grow-0 shrink-0 bg-black text-white pt-10">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center md:items-start">
                ...
                <form className="flex flex-row items-center">
                    ...
                    className="px-4 py-2 mr-2 text-black rounded"
                    />
                    <Button type="submit" className="px-4 py-2 bg-white text-black">
                        Subscribe
                    </Button>
                </form>
            </div>
        ...
        <div className="container mx-auto text-xs grid grid-cols-1 md:grid-cols-3 gap-8 py-4">
            ...
            <div className="flex flex-row justify-center">
                ...
                <Link href="https://www.facebook.com">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" stroke="#000000" x="0px" y="0px" width="25" height="25" viewBox="0 0 24 24">
